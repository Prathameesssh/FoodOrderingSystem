...
import FoodItems.MenuOperations;
import FoodItems.MenuStorage;
import cart.Cart;
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    try {
                        ...
                        if (selectedItem == null) throw new InvalidInputException("❌ Invalid item number.");
                ...
                case 3:
                    ...
                    try {
                        ...
                        if (removeIndex < 1) throw new InvalidInputException("❌ Invalid item index.");
                ...
                case 4:
                    ...
                    try {
                        ...
                        if (updateIndex < 1) throw new InvalidInputException("❌ Invalid item index.");

                        System.out.print("🔁 Enter new quantity: ");
                        int newQty = sc.nextInt();

                        if (newQty <= 0) throw new InvalidInputException("❌ Quantity must be greater than 0.");
