...
import Customer.CustomerOrderDetails;
...
public class Cart {
    ...
    public double viewCart() {
        ...
        for (Map.Entry<FoodItem, Integer> entry : cartItems.entrySet()) {
            ...
            groupedCart
                .computeIfAbsent(cuisine, k -> new LinkedHashMap<>())
        ...
        for (Map.Entry<String, Map<String, List<Map.Entry<FoodItem, Integer>>>> cuisineEntry : groupedCart.entrySet()) {
            ...
            for (Map.Entry<String, List<Map.Entry<FoodItem, Integer>>> categoryEntry : cuisineEntry.getValue().entrySet()) {
